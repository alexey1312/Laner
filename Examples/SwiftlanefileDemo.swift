...
// Example demonstrating Swiftlanefile usage
// Run with: swift Examples/SwiftlanefileDemo.swift

import Foundation

// This would normally be: import SwiftlaneDSL
// For demo purposes, we'll show the structure

print("Swiftlanefile Demo")
print("==================")
print()

// Example 1: Creating a Swiftlanefile
print("1. Creating a Swiftlanefile with lanes:")
print("""
...
print("Key Features:")
print("- Swiftlanefile is the root manifest type")
