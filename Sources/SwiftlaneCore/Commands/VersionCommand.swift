...
/// Shows version information for Swiftlane and the environment.
public struct VersionCommand: ParsableCommand {
    public static let configuration = CommandConfiguration(
        commandName: "version",
        abstract: "Show Swiftlane version and environment information"
    )
    ...
    public func run() throws {
        ...
        print("Swiftlane \(swiftlaneVersion)")
        print("")
