...
public enum ManifestError: Error, Sendable, Equatable {
    /// The Swiftlanefile.swift was not found at the expected location.
    ...
    /// The Swiftlane installation path could not be determined.
...
extension ManifestError: CustomStringConvertible {
    public var description: String {
        ...
        case .notFound(let path):
            return "Swiftlanefile.swift not found at: \(path.path)"
        ...
        case .installPathNotFound:
            return "Could not determine Swiftlane installation path"
        }
    }
}
