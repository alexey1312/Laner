    ...
    extension MatchCommand {
        ...
        struct MatchInitCommand: AsyncParsableCommand {
            ...
            func run() async throws {
                ...
                print("")
                print("Run 'laner match sync --type development' to sync certificates")
            }
        }
    }
