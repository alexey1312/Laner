...
// MARK: - SwiftlaneConfiguration Tests

@Suite("SwiftlaneConfiguration Tests")
struct SwiftlaneConfigurationTests {
    struct TestConfig: SwiftlaneConfiguration {
    ...
    func validatesUniqueLaneNames() throws {
        struct ValidConfig: SwiftlaneConfiguration {
            static var lanes: [Lane] {
                [
                    Lane(name: "a") { _ in },
                    Lane(name: "b") { _ in }
    ...
    func throwsForDuplicateLaneNames() {
        struct DuplicateConfig: SwiftlaneConfiguration {
            static var lanes: [Lane] {
                [
                    Lane(name: "same") { _ in },
                    Lane(name: "same") { _ in }
