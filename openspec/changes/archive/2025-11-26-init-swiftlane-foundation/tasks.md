...
- [x] 6.7 Create `LanerConfiguration` protocol
...
- [x] `laner version` shows correct version
- [x] `laner doctor` reports environment status
- [x] `laner build --help` shows all options
