...
## Extended Files in SwiftlaneMatch

```
Sources/SwiftlaneMatch/
├── API/
...
```bash
swiftlane upload testflight --ipa App.ipa
swiftlane upload testflight --ipa App.ipa --groups "QA,Internal" --changelog "Bug fixes"
```
